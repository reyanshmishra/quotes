...
public class StartPointSeekBar extends View {
    ...
    public StartPointSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (thumbImageDrawable == null) {
            thumbImageDrawable = getResources().getDrawable(R.drawable.range_thumb);
        }
        this.thumbImage = ((BitmapDrawable) thumbImageDrawable).getBitmap();
        this.thumbImage = Bitmap.createScaledBitmap(thumbImage, 50, 50, false);
        ...
        if (thumbImagePressedDrawable == null) {
            thumbImagePressedDrawable = getResources().getDrawable(R.drawable.range_thumb);
        }
        this.thumbPressedImage = ((BitmapDrawable) thumbImagePressedDrawable).getBitmap();
        this.thumbPressedImage = Bitmap.createScaledBitmap(thumbPressedImage, 50, 50, false);
